<%-- 
    Document   : sentapvd
    Created on : Jan 21, 2012, 1:34:36 PM
    Author     : Hiren
--%>
                ...
                <h2 style=" color: black">Your Current Project Messages :</h2>
                    ...
                    <%
                                ...
                                sg = con.createStatement();
                                    ...
                                    int i = 0;
                                    rt = st.executeQuery("SELECT * FROM Document_Master WHERE Sent_From = '"+uid+"' AND Document_Status = 'Approved' AND Project_ID = '"+project+"'");
                                    while(rt.next())
                                    {
                             ...
                             <%
                                   ...
                                   session.setAttribute("sentapvd",i);
                                   int sentapvd = (Integer)session.getAttribute("sentapvd");
