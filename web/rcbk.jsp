<%-- 
    Document   : rcbk
    Created on : Jan 21, 2012, 12:49:44 PM
    Author     : Hiren
--%>
                ...
                <h2 style=" color: black">Your Current Project Messages :</h2>
                    ...
                    <%
                                  ...
                                  while(ru.next())
                                  {
                                        ...
                                        while(rg.next())
                                        {
                                            ...
                                            while(rh.next())
                                            {
                                                ...
                                                if(n < m)
                                                {
                                                    //rd = sd.executeQuery("SELECT * FROM Document_Master WHERE Sent_From = '"+sfrom+"' AND Sent_To = '"+uid+"' AND Project_ID = '"+pr+"' AND Document_Status = 'Rejected' ");
                                                    //while(rd.next()){
                                    %>
                                                <br></br>
                             ...
                             <%
                                   ...
                                   session.setAttribute("rcbk",i);
                                   int rcbk = (Integer)session.getAttribute("rcbk");
