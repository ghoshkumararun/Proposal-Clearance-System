<%-- 
    Document   : crdoc
    Created on : Jan 19, 2012, 9:34:21 PM
    Author     : Hiren
--%>
...
<div id="content" style=" background-color:white">
            <div id="column-1" style=" background-color:white">
                <form action="create">
                 ...
                 <div style="background: #4A4A4A url('../img/menu-bg.gif') repeat-x 0 0">
                     <h2 style=" color: white">Create New Project :</h2>
                     <div style=" background-color:white"><br></br>
                         <h2>New Project ID &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type="text" name="newprojid"></input></h2><br></br>
                         <h2>New Project Name &nbsp;: <input type="text" name="newprojname"></input></h2><br></br>
