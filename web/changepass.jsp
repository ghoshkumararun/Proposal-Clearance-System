<%-- 
    Document   : changepass
    Created on : May 21, 2012, 11:52:42 AM
    Author     : Hiren
--%>
...
<hr class="noscreen"/>
        <div id="skip-menu"></div>
            ...
            <div id="column-1" style=" background-color:white">
                <br></br>
                <form action="change">
                <h1>Change the Password </h1><br></br>
                <h2>Enter old Password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type="text" name="old"></input></h2>
                <h2>Enter New Password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:  <input type="text" name="newpass"></input></h2>
                <h2>Reenter the New Password &nbsp;&nbsp;: <input type="text" name="renew"></input></h2><br></br>
                <input type="submit" name="done" value="Done" style=" margin-left: 25px"></input>
                </form>
