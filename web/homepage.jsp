<%-- 
    Document   : index
    Created on : Jan 19, 2012, 3:32:30 PM
    Author     : Hiren
--%>
...
<div id="content" style=" background-color:white">
            <div id="column-1" style=" background-color:white">
                <img src="b5.jpg" width="1182px" height="325px"></img>
                <%
                      if(eid.equals("Admin"))
                      {
                          Connection con;
                          ...
                          ru = su.executeQuery("SELECT Project_ID FROM Project_Master");

                %>

                <form action="dcreate">
                    <div class="content" style=" background:#4A4A4A url('../img/menu-bg.gif') repeat-x 0 0">
                     <h2 style=" color: white">Go to Project :</h2>
                     <div style=" background-color:white"><br></br>
                        <h2>Project Name : 
                        <select name="proje">
                            <%while(ru.next()) {%>
                            <option><%=ru.getString(1)%></option>
                            <%}%>
                        </select>
                        </h2><br></br>
                        <input type="image" src="enter3.jpg" style=" margin-left: 65px"></input>
                     </div>
                 </div>
                </form>
                <%}
                ...
                <form action="dcreate">
                    <div class="content" style=" background:#4A4A4A url('../img/menu-bg.gif') repeat-x 0 0">
                     <h2 style=" color: white">Go to Your Current Project :</h2>
                     <div style=" background-color:white"><br></br>
                        <h2>Project Name : <input type="text" name="proje"></input></h2><br></br>
                        <h2>Team Name &nbsp;&nbsp;&nbsp;: <input type="text" name="tname"></input></h2><br></br>
                        <input type="image" src="enter3.jpg" style=" margin-left: 65px"></input>
                     </div>
                 </div>
                </form>
			...
			<h3 style=" font-size: 14px">In Process Items</h3>
				...
				<div class="content">
                        ...
                        <h3 style=" font-size: 14px">Completed Items</h3>
                               ...
                               <div class="content">
                                    <a href="report.jsp">Archived</a><br></br>
