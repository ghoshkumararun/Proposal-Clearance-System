<%-- 
    Document   : sentfw
    Created on : Jan 21, 2012, 1:00:39 PM
    Author     : Hiren
--%>
...
<div id="content" style=" background-color: white">
    <div id="column-1" style=" background-color:white"><br></br>
        ...
        <h2 style=" color: black">Your Current Project Messages :</h2><br></br>
                    ...
                    <%
                        ...
                        <%
                                  i = i + 1;
                                   ...
                                   session.setAttribute("sentfw",i);
                                   int sentfw = (Integer)session.getAttribute("sentfw");
