<%-- 
    Document   : rcap
    Created on : Jan 21, 2012, 12:54:10 PM
    Author     : Hiren
--%>
   ...
   <%@page import="Pandya.Messages;" %>
        ...
        <%
            ...
            if(state.equals("false"))
            {
              ...
              Connection con;
              Statement su,sg,sh,kh;
              ResultSet ru,rg,rh,rj;
                ...
                <h2 style=" color: black">Your Current Project Messages :</h2>
                    ...
                    <%
                                ...
                                int i = 0;
                                    ...
                                    %>
                                                ...
                                                <div style=" background-color:inactiveborder">
                                                    <h2 style=" background:#4A4A4A url('../img/menu-bg.gif') repeat-x 0 0"><b style=" color: white">Message <%=(i+1)%> : <%=ru.getDate(7)%></b></h2>
                                                    <h2>Received From&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <%=ru.getString(2)%></h2>
                                                    <h2>Project Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <%=ru.getString(5)%></h2>
                                                    <h2>Document ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <%=ru.getString(1)%></h2>
                                                    <h2>Document Status &nbsp;: <%=ru.getString(4)%></h2>
                                                    <h2>Attachment Files&nbsp;&nbsp;&nbsp;:</h2>
                                                    <div id="column-1" style=" background-color:infobackground">

                                                    <h2>Description&nbsp;: <br></br><%=ru.getString(6)%></h2>
                                                    </div>
                                                </div><br></br>
                                                <% rj = kh.executeQuery("SELECT * FROM Document_Master WHERE Sent_From = '"+sfrom+"' AND Sent_To = '"+uid+"' AND Project_ID = '"+project+"' AND Document_Status = 'In Process' ");%>
                                                <form action="rcapprove">
                                                    <select name="userid">
                                                        <%
                                                          while(rj.next()){
                                                        %>
                                                        <option><%=rj.getString(2)%></option>
                                                        <%
                                                          }
                                                        %>
                                                    </select>
                             ...
                             <%
                                   ...
                                   session.setAttribute("rcap",i);
                                   int rcap = (Integer)session.getAttribute("rcap");
