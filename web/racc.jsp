<%-- 
    Document   : racc
    Created on : Jan 21, 2012, 12:56:31 PM
    Author     : Hiren
--%>
                ...
                <h2 style=" color: black">Your Current Project Messages :</h2>
                    ...
                    <%
                                ...
                                sh = con.createStatement();
                                    ...
                                    int i = 0;
                                    ru = su.executeQuery("SELECT * FROM Document_Master WHERE Sent_To = '"+uid+"' AND Project_ID = '"+project+"' ");
                                    while(ru.next())
                                    {
                            ...
                            %>
                             ...
                             <%
                                   ...
                                   session.setAttribute("racc",i);
                                   int racc = (Integer)session.getAttribute("racc");
