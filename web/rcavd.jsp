<%-- 
    Document   : rcavd
    Created on : Jan 21, 2012, 12:59:00 PM
    Author     : Hiren
--%>
...
<div id="content" style=" background-color:white">
    <div id="column-1" style=" background-color:white"><br></br>
                ...
                <h2 style=" color: black">Your Current Project Approved Messages :</h2>
                    ...
                    <%
                                ...
                                sh = con.createStatement();
                                    ...
                                    int i = 0;
                                    ru = su.executeQuery("SELECT * FROM Document_Master WHERE Sent_To = '"+uid+"' AND Document_Status = 'Approved' ");
                                    while(ru.next())
                                    {
                             ...
                             <%
                                   ...
                                   session.setAttribute("rcavd",i);
                                   int rcavd = (Integer)session.getAttribute("rcavd");
