<%-- 
    Document   : sentcr
    Created on : Jan 21, 2012, 1:29:35 PM
    Author     : Hiren
--%>
                ...
                <h2 style=" color: black">Your Current Project Messages :</h2>
                    ...
                    <%
                                ...
                                sg = con.createStatement();
                                 ...
                                 int i = 0;
                                 rt = st.executeQuery("SELECT * FROM Document_Master WHERE Sent_From = '"+uid+"' AND Project_ID = '"+project+"' AND Document_Status = 'In Process' ");
                                    while(rt.next())
                                    {
                                        ...
                                        while(ru.next())
                                        {
                                            ...
                                            while(rg.next())
                                            {
                                                ...
                                                if(n > m)
                                                {
                                                    //rh = sh.executeQuery("SELECT * FROM Document_Master WHERE Sent_From = '"+uid+"' AND Sent_To = '"+sto+"' AND Project_ID = '"+pr+"' ");
                                                    //while(rh.next()){
                                    %>
                                                <br></br>
                             ...
                             <%
                                   ...
                                   session.setAttribute("sentcr",i);
                                   int sentcr = (Integer)session.getAttribute("sentcr");
