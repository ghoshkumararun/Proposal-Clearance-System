<%-- 
    Document   : ractt
    Created on : Jan 24, 2012, 8:30:07 PM
    Author     : Hiren
--%>
                ...
                <h2 style=" color: black">Your Current Project Messages :</h2>
                    ...
                    <%
                                    ...
                                    while(ru.next())
                                    {
                                        ...
                                        while(rg.next())
                                        {
                                            ...
                                            while(rh.next())
                                            {
                                                ...
                                                if(n < m)
                                                {
                                                    //rd = sd.executeQuery("SELECT * FROM Document_Master WHERE Sent_From = '"+sfrom+"' AND Sent_To = '"+uid+"' AND Project_ID = '"+pr+"' AND Document_Status = 'In Process' ");
                                                    //while(rg.next()){
                                %>
                                                <br></br>
                             ...
                             <%
                                   ...
                                   session.setAttribute("ract",i);
                                   int ract = (Integer)session.getAttribute("ract");
